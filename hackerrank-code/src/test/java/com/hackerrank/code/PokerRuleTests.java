...
class PokerRuleTests {
    ...
    void contextLoads() throws Exception {
        String result = poker(List.of("A", "A", "J", "A", "A"));
    ...
    static String poker(List<String> kartu) {
    ...
    static String pokerSameRule(int jumlahKartuTerbanyak, int jumlahKartuTerbanyakKedua) {
